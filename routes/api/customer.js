...
router.put('/update-customer',authentication,authorization("Customer"), customerController.updateCustomerData);
...
router.get('/matchnumber',authentication,authorization("Customer"),  customerController.matchNumber);
