...
router.post("/add-user",authentication,authorization("User"),uploadHelper.uploadFiles('user', 'user_pic'), userModule.PostUser);
router.put("/update-user", authentication,authorization("User"),uploadHelper.uploadFiles('user', 'user_pic'), userModule.UpdateUserImage);
...
router.post('/update-profile', authentication, uploadHelper.uploadFiles('user', 'user_pic'), userModule.updateUserProfileImage);
