...
router.post("/add-crop",authentication, authorization("Crop"),uploadHelper.uploadFiles('crop', 'crop_pics'), cropController.addcrop)
router.put("/update-crop",authentication, authorization("Crop"),uploadHelper.uploadFiles('crop', 'crop_pics'), cropController.updatecrop)
