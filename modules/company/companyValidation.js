...
validations.validateAccess = (req, res, next) => {
  ...
  if (!isEmpty(errors)) {
    return otherHelper.sendResponse(res, httpStatus.BAD_REQUEST, false, null, errors, 'invalid object id', null);
  } else {
    next();
  }
};
// access Validation Code End
